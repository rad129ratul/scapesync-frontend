const Footer = () => {
  return (
    <footer style={{background: 'linear-gradient(to right, #14532d, #166534)'}}>
      <div className="container-custom" style={{paddingTop: '64px', paddingBottom: '64px'}}>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand Section */}
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              <img src="/images/Vector-1.png" alt="ScapeSync" className="h-8 w-auto logo-brightness" />
              <span className="ml-2 text-xl font-semibold text-white">
                ScapeSync
              </span>
            </div>
            <p className="text-gray-300 max-w-md" style={{fontSize: '16px', marginBottom: '32px', lineHeight: '1.6'}}>
              Your all-in-one platform for landscaping, streamline your workflow and grow your business with our comprehensive management solution.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-gray-400 text-sm">
            © 2025 ScapeSync. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
