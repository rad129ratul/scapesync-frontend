      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index}
              className={`bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl border border-gray-100 hover:border-green-200 transition-all duration-500 group ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
            ...
            >
              <div className="flex items-start space-x-4 mb-6">
                <div className="relative">
                  <img 
                    ...
                    className="w-16 h-16 rounded-full object-cover border-2 border-gray-100 group-hover:border-green-300 transition-colors duration-300"
                  />
              ...
              <div className="relative">
                <svg className="absolute -top-2 -left-1 w-8 h-8 text-gray-200 opacity-50" fill="currentColor" viewBox="0 0 32 32">
